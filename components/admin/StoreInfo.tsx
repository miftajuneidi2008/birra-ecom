...
import { dummyStoreDataType } from "@/lib/types"
import logo from '../../assets/gs_logo.jpg'
const StoreInfo = ({store}:{store:dummyStoreDataType}) => {
    console.log(store,"store info")
    return (
        <div className="flex-1 space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2 text-sm ">
                <Image width={36} height={36} src={store.user.image || logo} alt={store.user.name} className="w-9 h-9 rounded-full" />
                <div>
